import { info } from "@/app/(public)/cart/_components/section-info-order";
        ...
        <div className="cart-main bg-white rounded-sm">
          ...
          <section className="px-16 py-6">
            ...
            <div className="bg-[#ececec] rounded mb-6">
              ...
              <div className="p-4">
                {info?.map((item, index) => (
                  <SectionInfoOrderLine key={index} size="checkout" infoKey={item.infoKey} infoValue={item.infoValue} />
                ))}
                <div className="mt-4">
                  <span>
